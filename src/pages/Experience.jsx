...
const Experience = () => {
    return (
        <>
            <SectionContent title="Professional Experience" description="<TODO>" sectionId="experience">
                <div className="row">
                    {/*Left side */}
                    <div >
                        <div className="experience-timeline-item" data-aos="fade-up" data-aos-delay="100">
                            <div className="experience-item">
                                ...
                                <div className="experience-card">
                                    ...
                                    <p><FontAwesomeIcon icon={faLocationDot} /> Catelló de la Plana, Castelló, Spain (On-Site)</p>
                                    <ul>
                        ...
                        <div className="experience-timeline-item" data-aos="fade-up" data-aos-delay="100">
                            <div className="experience-item">
                                ...
                                <div className="experience-card">
                                    ...
                                    <p><FontAwesomeIcon icon={faLocationDot} /> Vila-real, Castelló, Spain (On-Site)</p>
                                    <ul>
