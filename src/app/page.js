        ...
        <section id={styles["hero"]} className={`${styles["hero"]} section dark-background`}>
            ...
            <div className="container" data-aos="zoom-out" data-aos-delay="100">
                ...
                <div className={styles["description"]}>
                    ...
                    <p>
                        I&apos;m graduated in <span>Degree in Video game Design and Development</span> and in the{" "}
                        <span>Master&apos;s Degree in Video Game Programming</span>.
                    </p>
                    <p>
                        With <span className={styles["sub"]}>+3 years of experience in videogame programming</span>, other{" "}
                        <span className={styles["sub"]}>4 years of experience as QA Technician</span>, and{" "}
                        <span className={styles["sub"]}>multiple personal projects</span> released, I&apos;m ready to overcome whatever challenge you
                        may throw to me!
                    </p>
                </div>
                ...
                <div className={styles["description"]}>
                    <p>
                        I&apos;m {age} years old, and a video game enthusiast and a passionate programmer that loves new technologies. DigiDestinied,
                        Pokémon trainer and D&D game master.
                    </p>
                </div>
