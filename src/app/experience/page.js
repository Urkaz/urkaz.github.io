            ...
            >
                <div className="row">
                    <div className={styles["experience-timeline-item"]} data-aos="fade-up" data-aos-delay="100">
                        <div className={styles["experience-item"]}>
                            <div className={styles["icon"]}>
                                <Image src="/img/experience/icons/catness_game_studios_logo.jpg" alt="" />
                            </div>
                            <div className={styles["experience-card"]}>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        Plugin and tool development to expand the engine base functionality: custom device profiles, mesh instancing
                                        editor tools, project analysis tools, custom blueprint nodes, async loading screen, right-click editor
                                        extensions with custom tasks, and more.
                                    </li>
                                    <li>
                                        Plugin and tool development to ease the porting process to consoles: Xbox user management, PS5 activities,
                                        Switch controller handling, and other optimization tools.
                                    </li>
                    ...
                    <div className={styles["experience-timeline-item"]} data-aos="fade-up" data-aos-delay="100">
                        <div className={styles["experience-item"]}>
                            <div className={styles["icon"]}>
                                <Image src="/img/experience/icons/lollipop_robot_logo.jpg" alt="" />
                            </div>
                            <div className={styles["experience-card"]}>
                                <h4>QA Technician</h4>
                                <h5>Lollipop Robot</h5>
                                <p>
                                    <FontAwesomeIcon icon={faCalendarDays} /> October 2016 - September 2020 (4 years)
                                </p>
                                <p>
                                    <FontAwesomeIcon icon={faLocationDot} /> Vila-real, Castelló, Spain (On-Site)
                                </p>
                                <ul>
                    ...
                    <div className={styles["experience-timeline-item"]} data-aos="fade-up" data-aos-delay="100">
                        <div className={styles["experience-item"]}>
                            ...
                            <div className={styles["experience-card"]}>
                                ...
                                <h5>Lollipop Robot</h5>
                                <p>
                                    <FontAwesomeIcon icon={faCalendarDays} /> February 2016 - July 2016 (6 months)
                                </p>
                                <p>
                                    <FontAwesomeIcon icon={faLocationDot} /> Vila-real, Castelló, Spain (On-Site)
                                </p>
